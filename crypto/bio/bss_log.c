...
static void xopenlog(ossl_unused BIO *bp, char *name, int level)
{
...
static void xsyslog(ossl_unused BIO *bp, int priority, const char *string)
{
    syslog(priority, "%s", string);
}

static void xcloselog(ossl_unused BIO *bp)
{
    closelog();
}
