...
static int uint64_new(ASN1_VALUE **pval, ossl_unused const ASN1_ITEM *it)
{
...
static void uint64_free(ASN1_VALUE **pval, ossl_unused const ASN1_ITEM *it)
{
    OPENSSL_free(*pval);
    *pval = NULL;
}

static void uint64_clear(ASN1_VALUE **pval, ossl_unused const ASN1_ITEM *it)
{
    **(uint64_t **)pval = 0;
}
...
static int uint32_new(ASN1_VALUE **pval, ossl_unused const ASN1_ITEM *it)
{
...
static void uint32_free(ASN1_VALUE **pval, ossl_unused const ASN1_ITEM *it)
{
    OPENSSL_free(*pval);
    *pval = NULL;
}

static void uint32_clear(ASN1_VALUE **pval, ossl_unused const ASN1_ITEM *it)
{
    **(uint32_t **)pval = 0;
}
