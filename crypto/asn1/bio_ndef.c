...
static int ndef_prefix(ossl_unused BIO *b, unsigned char **pbuf, int *plen,
                       void *parg)
{
...
static int ndef_prefix_free(ossl_unused BIO *b, unsigned char **pbuf, int *plen,
                            void *parg)
{
    NDEF_SUPPORT *ndef_aux;
...
static int ndef_suffix(ossl_unused BIO *b, unsigned char **pbuf, int *plen,
                       void *parg)
{
    NDEF_SUPPORT *ndef_aux;
    unsigned char *p;
