...
int
ip_create_listener_split (const char *ip, unsigned short port)
{
...
int
ip_create_connection_split (const char *ip, unsigned short port)
{
    struct sockaddr_in in_addr;
    int flags, fd = -1;
...
int
ip_create_listener (const char *address)
{
    const char *ip;
    unsigned short port;
...
int
ip_create_connection (const char *address)
{
    const char *ip;
    unsigned short port;
...
int
ip_accept_connection (int listen_fd)
{
