...
static const OSSL_ALGORITHM deflt_kdfs[] = {
    ...
    ALGDEF(PROV_NAMES_ARGON2I, ossl_kdf_argon2i_functions),
    ALGDEF(PROV_NAMES_ARGON2D, ossl_kdf_argon2d_functions),
    ALGDEF(PROV_NAMES_ARGON2ID, ossl_kdf_argon2id_functions),
#endif
    { NULL, NULL, NULL, NULL }
};
