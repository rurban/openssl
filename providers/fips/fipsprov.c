...
#define UNAPPROVED_ALG(NAMES, FUNC) { NAMES, FIPS_UNAPPROVED_PROPERTIES, FUNC, NAMES }
...
static const OSSL_ALGORITHM_CAPABLE fips_ciphers[] = {
    ...
    UNAPPROVED_ALGC(PROV_NAMES_DES_EDE3_ECB, ossl_tdes_ede3_ecb_functions, NULL),
    UNAPPROVED_ALGC(PROV_NAMES_DES_EDE3_CBC, ossl_tdes_ede3_cbc_functions, NULL),
...
#ifndef OPENSSL_NO_EC
# ifndef OPENSSL_NO_ECX
    UNAPPROVED_ALG(PROV_NAMES_ED25519, ossl_ed25519_signature_functions),
    UNAPPROVED_ALG(PROV_NAMES_ED448, ossl_ed448_signature_functions),
# endif
