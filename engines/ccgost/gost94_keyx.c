 ...
 */
static int
compute_pair_key_le (unsigned char *pair_key, BIGNUM * pub_key, DH * dh)
{
 ...
 */
static int
make_cp_exchange_key (BIGNUM * priv_key, EVP_PKEY * pubk,
...
int
pkey_gost94_derive (EVP_PKEY_CTX * ctx, unsigned char *key, size_t * keylen)
{
...
int
pkey_GOST94cp_encrypt (EVP_PKEY_CTX * ctx, unsigned char *out,
 ...
 */
int
pkey_GOST94cp_decrypt (EVP_PKEY_CTX * ctx, unsigned char *key,
