...
static int
VKO_compute_key (unsigned char *shared_key, size_t shared_key_size,
 ...
 */
int
pkey_gost2001_derive (EVP_PKEY_CTX * ctx, unsigned char *key, size_t * keylen)
{
...
int
pkey_GOST01cp_encrypt (EVP_PKEY_CTX * pctx, unsigned char *out,
 ...
 */
int
pkey_GOST01cp_decrypt (EVP_PKEY_CTX * pctx, unsigned char *key,
