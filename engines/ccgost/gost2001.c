 ...
 */
int
fill_GOST2001_params (EC_KEY * eckey, int nid)
{
 ...
 */
DSA_SIG *
gost2001_do_sign (const unsigned char *dgst, int dlen, EC_KEY * eckey)
{
    DSA_SIG *newsig = NULL;
 ...
 */
int
gost2001_do_verify (const unsigned char *dgst, int dgst_len,
 ...
 */
int
gost2001_compute_public (EC_KEY * ec)
{
    const EC_GROUP *group = EC_KEY_get0_group (ec);
