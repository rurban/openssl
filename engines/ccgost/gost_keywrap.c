 ...
 */
void
keyDiversifyCryptoPro (gost_ctx * ctx, const unsigned char *inputKey,
...
int
keyWrapCryptoPro (gost_ctx * ctx, const unsigned char *keyExchangeKey,
...
int
keyUnwrapCryptoPro (gost_ctx * ctx, const unsigned char *keyExchangeKey,
