...
static int gost_cipher_init_cpa (EVP_CIPHER_CTX * ctx,
...
static int gost89_set_asn1_parameters (EVP_CIPHER_CTX * ctx,
                                       ASN1_TYPE * params);
static int gost89_get_asn1_parameters (EVP_CIPHER_CTX * ctx,
                                       ASN1_TYPE * params);
/* Control function */
static int gost_cipher_ctl (EVP_CIPHER_CTX * ctx, int type, int arg,
                            void *ptr);
...
static int gost_imit_update (EVP_MD_CTX * ctx, const void *data,
                             size_t count);
...
const struct gost_cipher_info *
get_encryption_params (ASN1_OBJECT * obj)
{
    int nid;
...
static int
gost_cipher_set_param (struct ossl_gost_cipher_ctx *c, int nid)
{
...
gost_cipher_init_param (EVP_CIPHER_CTX * ctx, const unsigned char *key,
                        const unsigned char *iv, int enc, int paramNID,
                        int mode)
{
...
static int
gost_cipher_init_cpa (EVP_CIPHER_CTX * ctx, const unsigned char *key,
                      const unsigned char *iv, int enc)
{
    struct ossl_gost_cipher_ctx *c = ctx->cipher_data;
...
int
gost_cipher_init (EVP_CIPHER_CTX * ctx, const unsigned char *key,
                  const unsigned char *iv, int enc)
{
 ...
 */
static void
gost_crypt_mesh (void *ctx, unsigned char *iv, unsigned char *buf)
{
...
static void
gost_cnt_next (void *ctx, unsigned char *iv, unsigned char *buf)
{
    struct ossl_gost_cipher_ctx *c = ctx;
    word32 g, go;
...
int
gost_cipher_do_cfb (EVP_CIPHER_CTX * ctx, unsigned char *out,
                    const unsigned char *in, size_t inl)
{
...
static int
gost_cipher_do_cnt (EVP_CIPHER_CTX * ctx, unsigned char *out,
                    const unsigned char *in, size_t inl)
{
    const unsigned char *in_ptr = in;
    unsigned char *out_ptr = out;
...
int
gost_cipher_cleanup (EVP_CIPHER_CTX * ctx)
{
...
int
gost_cipher_ctl (EVP_CIPHER_CTX * ctx, int type, int arg, void *ptr)
{
    switch (type)
    {
...
int
gost89_get_asn1_parameters (EVP_CIPHER_CTX * ctx, ASN1_TYPE * params)
{
    int ret = -1;
    int len;
...
int
gost_imit_init_cpa (EVP_MD_CTX * ctx)
{
...
int
gost_imit_update (EVP_MD_CTX * ctx, const void *data, size_t count)
{
    struct ossl_gost_imit_ctx *c = ctx->md_data;
...
int
gost_imit_final (EVP_MD_CTX * ctx, unsigned char *md)
{
    struct ossl_gost_imit_ctx *c = ctx->md_data;
    if (!c->key_set)
    {
...
int
gost_imit_ctrl (EVP_MD_CTX * ctx, int type, int arg, void *ptr)
{
    switch (type)
    {
...
int
gost_imit_copy (EVP_MD_CTX * to, const EVP_MD_CTX * from)
{
...
/* Clean up imit ctx */
int
gost_imit_cleanup (EVP_MD_CTX * ctx)
{
